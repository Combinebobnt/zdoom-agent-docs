...
**Provenance:** ZDoom Wiki `CVARs:Debug` (retrieved 2026-08-02, oldid=49990) + verified against Zandronum source's `src/textures/animations.cpp:162` and behavior in `FTextureManager::InitAnimated()`.
