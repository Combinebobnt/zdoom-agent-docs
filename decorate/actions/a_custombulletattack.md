...
**Provenance:** ZDoom Wiki `A_CustomBulletAttack` (retrieved 2026-08-01, oldid=55199) + verified against the Zandronum source's `src/thingdef/thingdef_codeptr.cpp:1312-1373`.
...
## Divergence from upstream ZDoom
