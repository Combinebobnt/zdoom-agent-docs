...
**Provenance:** ZDoom Wiki `A_TakeInventory` (retrieved 2026-08-01, oldid=53732) + verified against the Zandronum source's `src/thingdef/thingdef_codeptr.cpp:2244-2333` and the native action declaration in `wadsrc/static/actors/actor.txt:218`.
