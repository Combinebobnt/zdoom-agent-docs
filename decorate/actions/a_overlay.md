...
**Provenance:** ZDoom Wiki `A_Overlay` (retrieved 2026-07-31, oldid=54630) + verified against UZDoom source's `src/playsim/p_pspr.cpp:1187-1205`.
...
- `statelabel start` — The state label the overlay should begin in (e.g., `"MuzzleFlash"`). If omitted or null, behavior is undefined; the wiki example always provides an explicit state.
