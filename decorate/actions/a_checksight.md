...
**Provenance:** ZDoom Wiki `A_CheckSight` (retrieved 2026-07-31, oldid=45585) + verified against the Zandronum source's `src/thingdef/thingdef_codeptr.cpp:3286-3329`.
