...
- `lighttag` *(optional, defaults to 0)* — if non-zero, a gradual lighting effect is applied to
  ...
  work is done. The ZDoom wiki page does not document this fork-specific compat-flag gate.
...
`oldid=46912`, ZDoom upstream) + source-verified against Zandronum fork
...
are this doc's source-verified additions. **Engine:** Zandronum 3.2.1 (verified against
